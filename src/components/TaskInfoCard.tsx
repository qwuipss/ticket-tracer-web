      ...
      <div>
        ...
        <div className="task-info-card">
          <div className="base-info">
            ...
            <h2 className="task-comments-header">
              Комментарии
            </h2>
            <div className="comments-section">
              <img className="user-photo" src="./imgs/user.png"></img>
          ...
          <div className="side-info">
            ...
            <div className="task-info-table">
              ...
              <div className="author">
                ...
                <div className="author-info">
                  <img className="author-photo" src="./imgs/user.png"></img>
              ...
              <div className="doer">
                ...
                <div className="doer-info">
                  <img className="doer-photo" src="./imgs/user.png"></img>
            ...
            <p className="create-info">Создано 2 апреля 2025 г. в 11:17</p>
