    ...
    <main className="board">
      ...
      <div className="task-board">
        <div className="task-column">
          <h2>К выполнению</h2>
          <div className="task-card" onClick={() => handleOpenModal(tasks[0])}>
            <p className="task-name-table">{tasks[0].name}</p>
            <div className="task-info">
              <img className="task-card-photo" src="/imgs/user.svg"></img>
        ...
        <div className="task-column">
          <h2>В работе</h2>
          <div className="task-card" onClick={() => handleOpenModal(tasks[1])}>
        ...
        <div className="task-column">
          <h2>Готово</h2>
          <div className="task-card" onClick={() => handleOpenModal(tasks[2])}>
