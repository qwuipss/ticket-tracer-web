...
/**
 * Builds and executes requests for operations under /tickets/all
 */
export interface AllRequestBuilder extends BaseRequestBuilder<AllRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<AllRequestBuilderGetQueryParameters> | undefined) : Promise<TicketModel[] | undefined>;
    /**
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const AllRequestBuilderUriTemplate = "{+baseurl}/tickets/all?offset={offset}{&limit*}";
/**
