...
export interface AllRequestBuilder extends BaseRequestBuilder<AllRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<AllRequestBuilderGetQueryParameters> | undefined) : Promise<ProjectModel[] | undefined>;
    /**
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const AllRequestBuilderUriTemplate = "{+baseurl}/projects/all?offset={offset}{&limit*}";
/**
